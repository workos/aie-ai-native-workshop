...
2. **First voice loop.** With Handy live, fix a seeded bug in [`../exercises/`](../exercises/) entirely by voice. Goal: feel how fast intent → change is when you talk at ~180 wpm instead of typing.
